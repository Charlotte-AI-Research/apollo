...
: ${AMENT_CURRENT_PREFIX:="/apollo/ros_ws/src/scout_mini_localization/install/scout_mini_localization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/scout_mini_localization/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/scout_mini_localization/environment/path.sh"
