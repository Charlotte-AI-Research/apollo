...
bool follow_human__msg__tracked_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("follow_human.msg._tracked_object.TrackedObject", full_classname_dest, 46) == 0);
  }
  follow_human__msg__TrackedObject * ros_message = _ros_message;
  {  // id
...
PyObject * follow_human__msg__tracked_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("follow_human.msg._tracked_object");
