...
bool follow_human__msg__depth_estimation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("follow_human.msg._depth_estimation.DepthEstimation", full_classname_dest, 50) == 0);
  }
  follow_human__msg__DepthEstimation * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of DepthEstimation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("follow_human.msg._depth_estimation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DepthEstimation");
