...
#include "scout_object_detector/msg/detail/yolo_detection__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = scout_object_detector::msg::YoloDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const scout_object_detector::msg::YoloDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scout_object_detector::msg::YoloDetection *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_scout_object_detector
const rosidl_message_type_support_t *
get_message_type_support_handle<scout_object_detector::msg::YoloDetection>()
{
  return &scout_object_detector::msg::typesupport_fastrtps_cpp::_YoloDetection__handle;
}
