...
{
  new (message_memory) test_detector::msg::YoloDetection(_init);
}

void YoloDetection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<test_detector::msg::YoloDetection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember YoloDetection_message_member_array[6] = {
  {
    ...
    offsetof(test_detector::msg::YoloDetection, class_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_detector::msg::YoloDetection, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_detector::msg::YoloDetection, xmin),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_detector::msg::YoloDetection, ymin),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_detector::msg::YoloDetection, xmax),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_detector::msg::YoloDetection, ymax),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers YoloDetection_message_members = {
  "test_detector::msg",  // message namespace
  "YoloDetection",  // message name
  6,  // number of fields
  sizeof(test_detector::msg::YoloDetection),
...
{
  return &::test_detector::msg::rosidl_typesupport_introspection_cpp::YoloDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_detector, msg, YoloDetection)() {
  return &::test_detector::msg::rosidl_typesupport_introspection_cpp::YoloDetection_message_type_support_handle;
}
