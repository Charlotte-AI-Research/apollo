...
#ifndef FOLLOW_HUMAN__MSG__DETAIL__TRACKED_OBJECT__FUNCTIONS_H_
#define FOLLOW_HUMAN__MSG__DETAIL__TRACKED_OBJECT__FUNCTIONS_H_
 ...
 * calls
 * follow_human__msg__TrackedObject__init().
...
/**
 * It calls
 * follow_human__msg__TrackedObject__fini()
 ...
 * follow_human__msg__TrackedObject__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * follow_human__msg__TrackedObject__Sequence__fini()
 * on the array,
...
#endif  // FOLLOW_HUMAN__MSG__DETAIL__TRACKED_OBJECT__FUNCTIONS_H_
