...
#include "follow_human/msg/detail/tracked_object__rosidl_typesupport_fastrtps_c.h"
...
using _TrackedObject__ros_msg_type = follow_human__msg__TrackedObject;
...
size_t get_serialized_size_follow_human__msg__TrackedObject(
  const void * untyped_ros_message,
...
static uint32_t _TrackedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_follow_human__msg__TrackedObject(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_follow_human
size_t max_serialized_size_follow_human__msg__TrackedObject(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = follow_human__msg__TrackedObject;
    is_plain =
      (
...
static size_t _TrackedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_follow_human__msg__TrackedObject(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, follow_human, msg, TrackedObject)() {
