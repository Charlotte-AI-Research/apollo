...
bool scout_object_detector__msg__yolo_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scout_object_detector.msg._yolo_detection.YoloDetection", full_classname_dest, 55) == 0);
  }
  scout_object_detector__msg__YoloDetection * ros_message = _ros_message;
  {  // class_name
...
PyObject * scout_object_detector__msg__yolo_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("scout_object_detector.msg._yolo_detection");
