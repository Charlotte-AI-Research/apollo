...
: ${AMENT_CURRENT_PREFIX:="/apollo_ws/src/scout_mini_navigation/install/scout_mini_navigation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/scout_mini_navigation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/scout_mini_navigation/environment/path.sh"
